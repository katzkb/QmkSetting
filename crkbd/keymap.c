...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|-------+-------+-------+-------+-------+-------|                 |-------+-------+-------+-------+-------+-------|
     KC_LCTL,RGB_HUI,KC_MS_L,KC_MS_D,KC_MS_R,KC_WH_D,                  RGB_VAI,KC_BTN1,KC_BTN2,  KC_NO,   KC_UP, KC_NO,\
  //|-------+-------+-------+-------+-------+-------|                 |-------+-------+-------+-------+-------+-------|
     KC_LSFT,RGB_HUD,RGB_SAD,KC_WH_L,KC_WH_R,KC_WH_U,                  RGB_VAD,  KC_NO,  KC_NO,KC_LEFT,KC_DOWN,KC_RGHT,\
  //|-------+-------+-------+-------+-------+-------|                 |-------+-------+-------+-------+-------+-------|
                                  KC_LGUI, KC_LALT, KC_ACL1,   KC_ACL0, KC_RALT, KC_TRNS \
                                  //`----------------------'  `-----------------------'
  )
};
